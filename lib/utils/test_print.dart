...
import 'package:flutter_bluetooth/utils/printerenum.dart';
...
class TestPrint {
  ...
  sample() async {
    ...
    // ByteData bytesData = await rootBundle.load("assets/icon_app.png");
    // String dir = (await getApplicationDocumentsDirectory()).path;
    // File file = await File('$dir/$filename').writeAsBytes(bytesData.buffer
    //     .asUint8List(bytesData.offsetInBytes, bytesData.lengthInBytes));

    ///image from Asset
    ByteData bytesAsset = await rootBundle.load("assets/icon_app.png");
